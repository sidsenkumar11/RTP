...
MAX_SAFE_UDP_SIZE    = 512
HEADER_SIZE          = 160
MAX_DATA_PER_SEGMENT = MAX_SAFE_UDP_SIZE - HEADER_SIZE
...
MAX_WINDOW_SIZE = math.ceil(MAX_BUFFER_SIZE / MAX_DATA_PER_SEGMENT)

# We'll assume an initial 65536 byte application data buffer (to match TCP).
INITIAL_BUFFER_SIZE = math.pow(2, 16)
INITIAL_WINDOW_SIZE = math.ceil(INITIAL_BUFFER_SIZE / MAX_DATA_PER_SEGMENT)
